...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { notes: @purchase_order.notes, status: @purchase_order.status, supplier_id: @purchase_order.supplier_id, total_amount: @purchase_order.total_amount }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { notes: @purchase_order.notes, status: @purchase_order.status, supplier_id: @purchase_order.supplier_id, total_amount: @purchase_order.total_amount }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
