class InventoryEvent < ActiveRecord::Base
  ...
  EVENTS_COLLECTION = [['ENTRADA', EVENT_ADD], ['SALIDA', EVENT_REMOVE], ['CONVERSIÓN', EVENT_CONVERT]]

  # ADD REASONS
  REASON_PURCHASE = 'PURCHASE'
  REASON_ORDER_DESTROY = 'ORDER_DESTROY'
  REASON_ORDER_CANCELED = 'ORDER_CANCELED'
  REASON_PROMO_DESTROY = 'PROMO_DESTROY'
  #REASON_CUSTOMER_REJECT_SHIPPING = 'CUSTOMER_REJECT_SHIPPING' # sería igual a ORDER_CANCELED. estaria bueno saber que se envió y no se aceptó pero es complicado
  ...
  ADD_REASONS = [REASON_PURCHASE, REASON_ORDER_DESTROY, REASON_ORDER_CANCELED, REASON_PROMO_DESTROY, REASON_CUSTOMER_RETURN, REASON_OTHER]
  ...
  ADD_REASONS_COLLECTION = [['COMPRA', REASON_PURCHASE], ['DEVOLUCIÓN DE CLIENTE', REASON_CUSTOMER_RETURN], ['OTRA', REASON_OTHER]]
