...
class CustomerContactsControllerTest < ActionController::TestCase
  ...
  test "should create customer_contact" do
    assert_difference('CustomerContact.count') do
      post :create, customer_contact: { customer_id: @customer_contact.customer_id, email: @customer_contact.email, name: @customer_contact.name, notes: @customer_contact.notes, phones: @customer_contact.phones }
    end
  ...
  test "should update customer_contact" do
    patch :update, id: @customer_contact, customer_contact: { customer_id: @customer_contact.customer_id, email: @customer_contact.email, name: @customer_contact.name, notes: @customer_contact.notes, phones: @customer_contact.phones }
    assert_redirected_to customer_contact_path(assigns(:customer_contact))
  end
